...
import com.example.util.FucUtil;
...
public class IatDemo extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.image_iat_set:
                Intent intent = new Intent(IatDemo.this,IatSettings.class);
            ...
            case R.id.iat_recognize:
                ...
                if (isShowDialog) {
                    ...
                    mIatDialog.show();
                    Toast.makeText(IatDemo.this,getString(R.string.text_begin),Toast.LENGTH_SHORT).show();
                } else {
                    // 不显示听写对话框
                    ret = mIat.startListening(mRecognizerListener);
                    if (ret != ErrorCode.SUCCESS) {
                        Toast.makeText(IatDemo.this,"听写失败,错误码：" + ret,Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(IatDemo.this,getString(R.string.text_begin),Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int i) {
            ...
            if(i != ErrorCode.SUCCESS) {
                Toast.makeText(IatDemo.this,"初始化失败，错误码:" + i,Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onBeginOfSpeech() {
            ...
            Toast.makeText(IatDemo.this,"开始说话",Toast.LENGTH_SHORT).show();
        }
        ...
        public void onError(SpeechError error) {
            ...
            if(mTranslateEnable && error.getErrorCode() == 14002) {
                Toast.makeText(IatDemo.this,error.getPlainDescription(true)+"\n请确认是否已开通翻译功能",Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(IatDemo.this,error.getPlainDescription(true),Toast.LENGTH_SHORT).show();
            }
        }
        ...
        public void onEndOfSpeech() {
            ...
            Toast.makeText(IatDemo.this,"结束说话",Toast.LENGTH_SHORT).show();
        }
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            Toast.makeText(IatDemo.this,"当前正在说话，音量大小：" + volume,Toast.LENGTH_SHORT).show();
    ...
    private void printTransResult(RecognizerResult results) {
        ...
        if( TextUtils.isEmpty(trans)|| TextUtils.isEmpty(oris) ){
            Toast.makeText(IatDemo.this,"解析结果失败，请确认是否已开通翻译功能。",Toast.LENGTH_SHORT).show();
